...
//
// Since: 2.0
func BindPreferenceBool(key string, p gui.Preferences) Bool {
...
//
// Since: 2.0
func BindPreferenceFloat(key string, p gui.Preferences) Float {
	binds := prefBinds.getBindings(p)
	if binds != nil {
		if listen := binds.getItem(key); listen != nil {
...
//
// Since: 2.0
func BindPreferenceInt(key string, p gui.Preferences) Int {
	binds := prefBinds.getBindings(p)
	if binds != nil {
		if listen := binds.getItem(key); listen != nil {
...
//
// Since: 2.0
func BindPreferenceString(key string, p gui.Preferences) String {
	binds := prefBinds.getBindings(p)
	if binds != nil {
		if listen := binds.getItem(key); listen != nil {
